...
<div class="col-sm p-3 min-vh-80">
    <div class="container-fluid" style="height:80vh">
        <div class="row" style="justify-content: center; height: 80vh">
            <div class="card mb-3 d-none d-lg-block d-xl-block d-md-block" style="width: 80%; height: 80vh">
                <div class="card-body">
                    <h5 class="card-title text-center" style="font-size: 2rem">Código QR</h5>
                        ...
                        <div class="container"  style="display: flex; justify-content:center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="70%" height="500px" fill="currentColor" class="bi bi-qr-code" viewBox="0 0 16 16">
            ...
            <div class="d-sm-block d-lg-none d-xl-none d-md-none" style="color: white">
