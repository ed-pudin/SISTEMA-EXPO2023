...
<div class="d-flex justify-content-center mt-4 flex-wrap">
    ...
    <form id="form" action="{{route('staffExpositor.store')}}" method="post">
        @csrf
        <input hidden type="text" name="matricula" id="matricula">
        <button hidden id="btnsend" type="submit"></button>
    </form>
